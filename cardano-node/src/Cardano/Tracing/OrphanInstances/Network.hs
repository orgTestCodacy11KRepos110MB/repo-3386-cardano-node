...
instance FromJSON NodeToNodeVersion where
  ...
  parseJSON _          = fail "FromJSON.NodeToNodeVersion: error parsing NodeToNodeVersion"
...
instance FromJSON NodeToClientVersion where
  ...
  parseJSON _          = fail "FromJSON.NodeToClientVersion: error parsing NodeToClientVersion"
