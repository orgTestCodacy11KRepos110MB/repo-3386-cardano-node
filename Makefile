...
PROFILES_PLUTUSCALL   := plutuscall-loop plutuscall-secp-ecdsa plutuscall-secp-schnorr
PROFILES_PLUTUSCALL   += plutuscall-loop-stepshalf plutuscall-secp-ecdsa-stepshalf plutuscall-secp-schnorr-stepshalf
PROFILES_PLUTUSCALL   += plutuscall-loop-doubleb plutuscall-secp-ecdsa-doubleb plutuscall-secp-schnorr-doubleb
